module.exports = (app) => {
    ...
    //delete an address 
    app.delete('/address/remove/:id',passport.authenticate('jwt', {session : false}), Address.remove);
    ...
    //get a order by id 
    app.get('/order/get/:id/:userID',passport.authenticate('jwt', {session : false}),
     Order.getOrderById);
